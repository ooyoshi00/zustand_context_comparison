...
import { useZustandClientStore } from '../store/zustandClientStore';
import { useCallback } from 'react';
import { useShallow } from 'zustand/shallow';

export const TodoContainer = () => {
	const { buttonColor, isModalOpen, addTodo, openModal, closeModal, saveToStorage } = useZustandClientStore(
		useShallow((state) => ({
